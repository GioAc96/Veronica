...
public abstract class RouterFactory<
    ...
    protected RouterFactory<Q, S> fallbackRoute(@NonNull Factory<Route<Q, S>> fallbackRouteFactory) throws CreationException {
    ...
    protected RouterFactory<Q, S> route(@NonNull Factory<Route<Q, S>> routeFactory, Integer priority) throws CreationException {
